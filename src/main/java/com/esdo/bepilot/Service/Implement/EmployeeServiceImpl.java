...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    public EmployeeResponse createNewEmployee(EmployeeRequest employeeRequest) {
        ...
        log.info(new Date() + " : " + this.getClass().getName() + ": finish createNewEmployee");
    ...
    public ListEmployeeResponse findAllEmployee(Integer page, Integer size, String key) {
        ...
        log.info(new Date() + " : " + this.getClass().getName() + ": finish findAllEmployee");
        return response;
    }
    ...
    public EmployeeResponse findEmployeeById(Long id) {
        ...
        log.info(new Date() + " : " + this.getClass().getName() + ": finish findEmployeeById");
    ...
    public EmployeeResponse editEmployeeById(Long id, EmployeeRequest request) {
        ...
        log.info(new Date() + " : " + this.getClass().getName() + ": finish editEmployeeById");
    ...
    public void deleteEmployeeById(Long id) {
        ...
        log.info(new Date() + " : " + this.getClass().getName() + ": finish deleteEmployeeById");
    }
}
