...
public class ConfigServiceImpl implements ConfigService {
    ...
    public ConfigResponse getConfig() {
        ...
        log.info(new Date() + " : " + this.getClass().getName() + ": finish getConfig");
        return response;
    }
    ...
    public ConfigResponse editConfig(ConfigRequest request) {
        CheckValid.checkConfigRequest(request);
        ...
        log.info(new Date() + " : " + this.getClass().getName() + ": finish editConfig");
        return response;
    }
}
